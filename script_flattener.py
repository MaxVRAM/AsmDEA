    ...
    for root, _, files in os.walk(src_dir):
        for file in files:
            if details and file.endswith(".asmdef"):
                # Path to the asmdef file, relative to the source directory
                asmdef_path = os.path.join(root, file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--details", type=bool, default=False, help="Comment .CS files with asmdef name and path.")
